...
with open('Test_dataset.json', 'rb') as file:
    text = json.load(file)
    input_list = []
    output_list = []
...
for item in text:
    ...
    for answer in item.get("answers", []):
        ...
        modified_output = pad_sequence(modified_output, block_size, Pad_token)
    ...
    def generate_response(self,prompt):
     ...
     with torch.no_grad():
        ...
        for _ in range(max_length):
            ...
            text_padded.append(target_tensor_next)
...
accuracy, bleu, meteor = evaluate_model(test_data)
